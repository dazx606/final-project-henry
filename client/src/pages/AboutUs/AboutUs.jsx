        ...
        <div className={styles.container}>
            <div className={styles.container1}>
                <div className={styles.subContainer1a}>
                    ...
                    <p className={styles.paragraph}>Luxurent is an auto rental service based in Buenos Aires, offering a range of luxury and daily car rentals. Make your trip to the beautiful city of Buenos Aires or some of cities where we are, absolutely perfect by choosing one of our many rental options.</p>
                    <br />
            ...
            <div className={styles.container2}>
                ...
                <div className={styles.subContainer2b}>
                    ...
                    <p className={styles.paragraph}>For premium car rentals in Latam, contact Luxurent!</p>
                </div>
            </div>
