...
function FaqItem({ title, text1, text2 }) {
    ...
    return (
        ...
        <div onClick={e => handleClick(e)} className={styles.bigContent} >

            <div className={styles.content}>
                <input type="checkbox" className={styles.checkbox2} checked={display} onChange={() => { }} />
            ...
            <div className={styles.textCont}>
                <input type="checkbox" className={styles.checkbox} checked={display} onChange={() => { }} />
